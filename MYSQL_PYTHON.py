...
def add_column():
    ...
    print('Space : ')
    space = int(input())
    sql = f"ALTER TABLE {table} ADD COLUMN {colname} {dtype}({space})"
    try:
        cursor.execute(sql)
        database.commit()
...
def modify_column():
    ...
    print('Space : ')
    space = int(input())
    sql = f"ALTER TABLE {table} MODIFY COLUMN {colname} {dtype}({space})"
    try:
        cursor.execute(sql)
        database.commit()
...
def drop_column():
    ...
    print('Column Name : ')
    colname = input()
    sql = f"ALTER TABLE {table} DROP COLUMN {colname}"
    try:
        cursor.execute(sql)
        database.commit()
